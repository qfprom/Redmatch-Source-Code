...
namespace ExitGames.Client.Photon
{
	public abstract class PeerBase
	{
		...
		internal virtual bool DeserializeMessageAndCallback(StreamBuffer stream)
		{
			...
			case 3:
			{
				OperationResponse operationResponse = SerializationProtocol.DeserializeOperationResponse(stream);
			...
			case 4:
			{
				EventData eventData = SerializationProtocol.DeserializeEventData(stream);
				if (TrafficStatsEnabled)
				{
